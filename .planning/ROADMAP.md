...
- [x] 02-04-PLAN.md — Deal coaching + remaining-token role recording
...
- [x] 02-06-PLAN.md — Persisted session integrity (semantic hydrate, durable save, prohibition fixtures)
...
- [x] 03-01-PLAN.md — Wave 0 RED unit + Playwright gates; invert Night ready /play stub contracts
...
- [x] 03-03-PLAN.md — coach-copy + composePrompt + full-screen Next/expand/Back coach UX

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 03-04-PLAN.md — Minion/Demon Info gating + Demon bluff picker + soft confirm; green play-coach E2E
