...
| 02-02-T2 / 02-05-T2 | 02 / 05 | 2 / 5 | SETUP-05 | — | Script → players → difficulty → bag → deal → record order enforced; Night ready stays on /setup | e2e | `npx playwright test e2e/setup-wizard.spec.ts e2e/setup-record.spec.ts` | ✅ exists | ✅ green |
