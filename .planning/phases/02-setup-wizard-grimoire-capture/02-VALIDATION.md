...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 02-02-T2 | 02 | 2 | SETUP-01 | T-02-02 | Unique names + seating 5–15 gate | e2e | `npx playwright test e2e/setup-wizard.spec.ts` | ✅ exists | ❌ red until 02-02 |
...
| 02-02-T2 / 02-05-T2 | 02 / 05 | 2 / 5 | SETUP-05 | — | Step order enforced (no skip ahead); Night ready stays on /setup | e2e | `npx playwright test e2e/setup-wizard.spec.ts e2e/setup-record.spec.ts` | ✅ wizard scaffold | ❌ red until 02-02 |
...
| 02-01-T2 / 02-02-T2 | 01 / 02 | 1 / 2 | — | — | `/setup` stub copy removed; `/play` still stub | e2e | update `e2e/stubs.spec.ts` | ✅ rewritten | ❌ red until 02-02 |
