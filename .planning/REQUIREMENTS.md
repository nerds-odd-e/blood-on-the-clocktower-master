...
- [x] **SETUP-02**: Storyteller can set game difficulty at the start of a game
- [x] **SETUP-03**: Storyteller can optionally set experience, age band, and notes per player (sensible defaults when blank)
- [x] **SETUP-04**: App generates a legal Trouble Brewing bag from player count, difficulty, and optional player profiles
...
- [x] **PLAT-02**: App works offline as a PWA after first load with no account required
